...
#STORING OF THE LISTS THAT WILL BE CALLED                               
var_discount_1 = 200                      
var_discount_2 = 1000                     
var_discount_3 = 5000                     
...
def def_main():
    while True:
        print("*" * 28 + "KAMA RESTUARANT" + "*" * 24 + "\n") 
        print("*" * 31 + "KAMA MAIN MENU" + "*" * 32 + "\n"     
              "\t(O) ORDER\n"                              
              "\t(R) REPORT\n"
              "\t(P) PAYMENT\n"
              "\t(E) EXIT\n" +
        ...
        input_1 = str(input("You are welcome- input your prefered choice: ")).upper()    
        if (len(input_1) == 1):                                           
            if (input_1 == 'O'):                                          
                print("\n" * 10)                                        
                def_order_menu()                                          
...
def def_food_drink_order():
    while True:
            ...
            input_1 = input("You are welcome- input your prefered choice: ").upper() 
            if (input_1 == 'M'):
                print("\n" * 10)
                def_main() 
                break
